...
{
    public static async Task SeedData(AppDbContext context) //dont need to create a new instance of this class because of static
    {
        ...
        context.Activities.AddRangeAsync(activities); //ef is tracking updates in memory
